...
const Success = () => {
    ...
    return (
        <div className=" font-inter min-h-screen ">
            <div style={{ borderBottom: "0.001px solid grey" }}>
                <img src={logo} alt="logo" className=" w-[13%] flex justify-start m-3" />
            </div>

            <img src={success} alt="success" className=" mx-auto w-[8%] mt-10" />
            ...
            <div className="   text-center">
                <button className=" text-xl text-white bg-[#ed653b] h-12 font-medium  w-[180px] rounded-md shadow-2xl hover:text-[#ed653b] hover:bg-white hover:border-2 hover:border-[#ed653b] transition-all ease-linear duration-300 mt-5  mb-10" onClick={() => {
